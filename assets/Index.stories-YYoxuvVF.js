...
`,H={title:"Month-1/Week-1/Day-1: Contador",component:r,parameters:{docs:{description:{component:q}}},argTypes:{initialValue:{control:{type:"number"}}}},i=()=>({components:{Index:r},template:"<Index />"}),c=()=>({components:{Index:r},setup:()=>({value:5}),template:"<Index :initialValue='value'/>"}),u=()=>({components:{Index:r},setup:()=>({value:20}),template:"<Index :initialValue='value'/>"}),d=n=>({components:{Index:r},setup:()=>({args:n}),template:'<Index :initialValue="args.initialValue" />'});var g,y,b;i.parameters={...i.parameters,docs:{...(g=i.parameters)==null?void 0:g.docs,source:{originalSource:`() => ({
  components: {
    Index
  },
  template: "<Index />"
})`,...(b=(y=i.parameters)==null?void 0:y.docs)==null?void 0:b.source}}};var _,V,S;c.parameters={...c.parameters,docs:{...(_=c.parameters)==null?void 0:_.docs,source:{originalSource:`() => ({
  components: {
    Index
  },
  setup: () => ({
  ...
  template: "<Index :initialValue='value'/>"
})`,...(h=(T=u.parameters)==null?void 0:T.docs)==null?void 0:h.source}}};var C,w,D;d.parameters={...d.parameters,docs:{...(C=d.parameters)==null?void 0:C.docs,source:{originalSource:`(args: ArgTypes) => ({
  components: {
    Index
  },
  setup: () => ({
...
})`,...(D=(w=d.parameters)==null?void 0:w.docs)==null?void 0:D.source}}};const J=["Default","StartInFive","StartInTwenty","Interactive"];export{i as Default,d as Interactive,c as StartInFive,u as StartInTwenty,J as __namedExportsOrder,H as default};
